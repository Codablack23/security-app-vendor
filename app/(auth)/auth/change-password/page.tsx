            ...
            <section className="bg-white flex-1 max-w-[700px] px-4 min-h-[431px] py-20">
                <form onSubmit={onSubmit} action="" className="max-w-[350px] mx-auto">
                    ...
                    <div className="space-y-5 py-8">
                        <input type="text" className="border-[rgba(208,213,221,1)] border w-full h-11 p-2 rounded-lg" placeholder="New password" />
                        <input type="password" className="border-[rgba(208,213,221,1)] h-11 p-2 w-full border rounded-lg" placeholder="Re-enter new Password" />
                    </div>
